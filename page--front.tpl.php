		   ...
		   <?php if ($logo): ?>
		    ...
		    <?php if ($site_name || $site_slogan): ?>
              <div id="name-and-slogan">
                ...
                <?php endif; ?>
                <?php if ($site_slogan): ?>
                  <div id="site-slogan" class="seven columns">
	    	     <span><?php print $site_slogan; ?></span>
		     <img src="/sites/minecraft.binaryalchemist.org/themes/skeletoncraft/images/site-slogan.png" />
		  </div>
                <?php endif; ?>
              </div> <!-- /#name-and-slogan -->
            <?php endif; ?>
	      ...
	      <footer id="footer">
		    <div id="footer" class="container">
			  ...
			  <div id="credits" class="eight columns">
			    Site by the <a href="http://www.binaryalchemist.org" title="Binary Alchemist">Binary Alchemist</a>
			  </div>
			  <div class="clear"></div>
		    </div><!-- /#footer -->
		  </footer>
